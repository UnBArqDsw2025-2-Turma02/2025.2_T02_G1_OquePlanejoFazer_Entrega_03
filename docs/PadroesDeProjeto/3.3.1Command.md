...
### 2.1 Estrutura do Padrão no Projeto
...
### 4.1 Estrutura de Implementação
...
#### 4.1.1 Classe Base e Comandos Concretos
...
#### 4.1.2 Serviço de Tarefas (Receiver)
...
#### 4.2.1 Edição Simples de Tarefa
...
#### 4.2.2 Conversão Automática de Tipo
